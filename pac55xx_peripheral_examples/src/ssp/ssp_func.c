...
void ssp_init(SSP_TYPE ssp, SSP_MS_TYPE ms_mode)
{
    ...
    ssp_ptr->CLK.M = 2;
    ssp_ptr->CLK.N = 254;                                    // N nust be event value from 2 to 254
    ...
    ssp_ptr->CON.CPH = SSP_PUT_PHASE_1;                      // Clock Out Phase, SPI captuers data sat 1st edge transition of the frame
