...
typedef enum {
#if !defined(PAC5556) && !defined(PAC5527)  // PAC5556 and PAC5527 don't have CFGDRV0
...
#if defined(PAC5527)
    ADDR_DRVILIMLS = 0x79,                  /*!< Driver Manager Lowside Driver Current Limit Configuration  */
    ADDR_DRVILIMHS = 0x7A,                  /*!< Driver Manager Highside Driver Current Limit Configuration */
#endif
